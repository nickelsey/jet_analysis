...
Run7EffOld::Run7EffOld(TString mfName)
{
  ...
  //DEBUG:
  //cout<<endl;
  //cout<<"Default constructor of Run7EffOld ..."<<endl;
}

Run7EffOld::~Run7EffOld()
{
  delete effY06;
  ...
  //DEBUG:
  //cout<<endl;
  //cout<<"Destructor of Run7EffOld ..."<<endl;
}

//void Run7EffOld::Clear()
//{
//}

void Run7EffOld::PrintInfo()
{
...
TF2* Run7EffOld::GetEffY04(Int_t cb)
{
...
Double_t Run7EffOld::EffAAY07_20(Double_t eta, Double_t mPt)
{
...
Double_t Run7EffOld::EffAAY07(Double_t eta, Double_t mPt, Int_t centBin)
{
...
Double_t Run7EffOld::EffPPY06(Double_t eta, Double_t mPt)
{
  Double_t effWeight=1.0;
...
Double_t Run7EffOld::EffRatio(Double_t eta, Double_t mPt, Int_t centBin)
{
  return EffAAY07(eta,mPt,centBin)/EffPPY06(eta,mPt);
}

Double_t Run7EffOld::EffRatio_20(Double_t eta, Double_t mPt)
{
...
Double_t Run7EffOld::EffRatio_20_Unc(Double_t eta, Double_t mPt)
{

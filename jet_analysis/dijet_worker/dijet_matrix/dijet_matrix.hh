...
public:
  ...
  std::unordered_map<std::string, std::unique_ptr<DijetDefinition>>& DijetDefinitions() 
                                                                           {return dijet_defs;}
...
protected:
  ...
  std::unordered_map<std::string, std::unique_ptr<DijetDefinition>> dijet_defs;
  std::set<std::unique_ptr<MatchDef>> lead_matchdefs;
  std::set<std::unique_ptr<MatchDef>> sub_matchdefs;

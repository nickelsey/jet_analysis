...
if __name__ == "__main__":
  ...
  parser.add_argument('--embedFile', default='submit/y7_mb_file_list.txt', help=' file containing list of root files for embedding events')
  parser.add_argument('--efficiencyFile', default='submit/y7_effic.root', help=' root file containing run 14 efficiency curves')

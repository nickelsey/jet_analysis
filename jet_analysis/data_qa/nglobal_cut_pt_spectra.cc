...
int main(int argc, char* argv[]) {
  ...
  for (int i = 1; i < argc; ++i) {
    if (ParseStrFlag(string(argv[i]), "--name", &opts.name) ||
        ...
        ParseStrFlag(string(argv[i]), "--nglobal", &opts.nglobal) ||
        ...
        ParseFloatFlag(string(argv[i]), "--fitfrac", &opts.fitfrac) ||
        ParseFloatFlag(string(argv[i]), "--nglobsigma", &opts.nglobsigma) ||
        ParseIntFlag(string(argv[i]), "--maxnglobal", &opts.maxnglobal)) continue;
